...
**平台热门岗位方向：**
- 技术类：前端开发、后端开发、算法工程师、数据分析师
- 产品类：产品经理、项目经理
- 其他：嵌入式开发、测试工程师、UI设计师

您可以告诉我您的专业背景或意向岗位，我帮您提供更具体的建议！""",
        "category": "岗位招聘",
        "keywords": "推荐岗位,找工作,求职,岗位推荐"
    },
    {
        "question": "我想找工作，有什么建议吗？",
        "answer": """很高兴帮您找工作！以下是我的建议：

**使用平台找工作的步骤：**
1. 确保您已注册并登录学生账号
2. 点击【岗位招聘】浏览所有岗位
3. 使用搜索功能，输入您感兴趣的岗位关键词
4. 根据地区、经验要求筛选合适的岗位
5. 找到心仪岗位后，点击【立即沟通】与HR交流
...
您是什么专业的呢？我可以给您更针对性的建议！""",
        "category": "岗位招聘",
        "keywords": "找工作,求职,就业,工作推荐"
    },
    {
        "question": "如何浏览岗位？",
        "answer": """浏览岗位步骤：
